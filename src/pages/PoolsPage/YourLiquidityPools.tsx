...
import { Pair } from '@smartdev1990/quick-sdk1';
...
const YourLiquidityPools: React.FC = () => {
	...
	return (
		<>
			{openPoolFinder && <PoolFinderModal open={openPoolFinder} onClose={() => setOpenPoolFinder(false)} />}
			...
			<Box mt={3}>
				{v2IsLoading ? (
					...
					<Box textAlign='center'>
						<img src={NoLiquidity} alt='No Liquidity' className='noLiquidityImage' />
