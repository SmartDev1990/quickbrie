...
import { Currency, Token } from '@smartdev1990/quick-sdk1';
...
const SwapProInfo: React.FC<{
	...
	const TokenInfo: React.FC<{ currency: Currency; tokenData: any }> = ({ currency, tokenData }) => {
				...
				<Box p={1} display='flex'>
					...
					<Box ml={1} flex={1}>
						...
						{tokenData ? (
							<span>
								{t('24h')}:{' '}
								<span className={priceUpPercent > 0 ? 'text-success' : 'text-error'}>
