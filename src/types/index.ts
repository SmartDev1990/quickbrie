import { TokenAmount, Token, Price, Pair } from '@smartdev1990/quick-sdk1';
...
export interface SyrupInfo {
	...
	getHypotheticalRewardRate: (stakedAmount?: TokenAmount, totalStakedAmount?: TokenAmount) => TokenAmount | undefined;
}
