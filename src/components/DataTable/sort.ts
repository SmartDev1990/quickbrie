export function descendingComparator<T>(a: T, b: T, orderBy: (data: T) => string | number): number {
...
export function getComparator<T>(order: SortOrder, orderBy: Comparable<T>): (a: any, b: any) => number {
	return order === 'desc'
