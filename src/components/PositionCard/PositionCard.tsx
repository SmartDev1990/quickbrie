import { JSBI, Pair, Percent } from '@smartdev1990/quick-sdk1';
...
export const MinimalPositionCard: React.FC<PositionCardProps> = ({ pair, border, showUnwrapped = false }) => {
	...
	return (
		<Box className='minimalCardWrapper' border={border}>
			{userPoolBalance && JSBI.greaterThan(userPoolBalance.raw, JSBI.BigInt(0)) ? (
				<Box>
					<p>{t('yourposition')}</p>
					<Box className='minimalCardRow' onClick={() => setShowMore(!showMore)}>
