import { Currency, ETHER, Token } from '@smartdev1990/quick-sdk1';
...
const CurrencyLogo: React.FC<CurrencyLogoProps> = ({ currency, size = '24px', style }) => {
	...
	if (currency === ETHER) {
		return (
			<Box style={style} width={size} height={size} borderRadius={size} className='currencyLogo'>
	...
	return (
		<Box width={size} height={size} borderRadius={size} className='currencyLogo bg-white'>
