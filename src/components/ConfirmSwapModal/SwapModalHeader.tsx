import { Trade, TradeType } from '@smartdev1990/quick-sdk1';
	...
	return (
		<Box>
			...
			<Box className='swapContent'>
				<p>
					{t('swap')} {formatTokenAmount(trade.inputAmount)} {trade.inputAmount.currency.symbol} ($
					{Number(usdPrice?.toSignificant()) * Number(trade.inputAmount.toSignificant(2))})
				</p>
				<ArrowDownIcon />
				<p>
					{formatTokenAmount(trade.outputAmount)} {trade.outputAmount.currency.symbol}
				</p>
			</Box>
			{showAcceptChanges && (
