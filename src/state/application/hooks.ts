...
export function useTokenDetails(): {
	...
	const tokenDetails = useSelector((state: AppState) => state.application.tokenDetails);
	const dispatch = useDispatch();
...
export function useBookmarkTokens(): {
	...
	const bookmarkedTokens = useSelector((state: AppState) => state.application.bookmarkedTokens);
	const dispatch = useDispatch();
...
export function useBookmarkPairs(): {
	...
	const bookmarkedPairs = useSelector((state: AppState) => state.application.bookmarkedPairs);
	const dispatch = useDispatch();
...
export function useIsProMode(): {
	...
	const isProMode = useSelector((state: AppState) => state.application.isProMode);
	const dispatch = useDispatch();
