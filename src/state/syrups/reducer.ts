...
const initialState: SyrupsListsState = {
	...
	byUrl: {
		...DEFAULT_LIST_OF_LISTS.reduce<Mutable<SyrupsListsState['byUrl']>>((memo, listUrl) => {
...
export default createReducer(initialState, (builder) =>
	builder
		.addCase(fetchSyrupList.pending, (state, { payload: { requestId, url } }) => {
			state.byUrl[url] = {
				...state.byUrl[url],
		...
		.addCase(fetchSyrupList.fulfilled, (state, { payload: { requestId, syrupList, url } }) => {
		...
		.addCase(fetchSyrupList.rejected, (state, { payload: { url, requestId, errorMessage } }) => {
