...
const AnalyticsTokenDetails = lazy(() => import('./pages/AnalyticsTokenDetails'));
const AnalyticsPairDetails = lazy(() => import('./pages/AnalyticsPairDetails'));
const AnalyticsOverview = lazy(() => import('./pages/AnalyticsPage/AnalyticsOverview'));
const AnalyticsHeader = lazy(() => import('./pages/AnalyticsPage'));
const AnalyticsTokens = lazy(() => import('./pages/AnalyticsPage/AnalyticsTokens'));
const AnalyticsPairs = lazy(() => import('./pages/AnalyticsPage/AnalyticsPairs'));
...
const Web3ProviderNetwork = createWeb3ReactRoot(GlobalConst.utils.NetworkContextName);
