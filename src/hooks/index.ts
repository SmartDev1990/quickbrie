...
export function useActiveWeb3React(): Web3ReactContextInterface<Web3Provider> & {
	...
	const contextNetwork = useWeb3ReactCore<Web3Provider>(GlobalConst.utils.NetworkContextName);
...
export function useEagerConnect() {
	...
	useEffect(() => {
		Promise.race([safeApp.getSafeInfo(), new Promise((resolve) => setTimeout(resolve, 100))]).then(
			(safe) => {
