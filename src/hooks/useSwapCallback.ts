...
import { JSBI, Percent, Router, SwapParameters, Trade, TradeType } from '@smartdev1990/quick-sdk1';
...
export function useSwapCallback(
	...
	callback: null | (() => Promise<{ response: TransactionResponse; summary: string }>);
	error: string | null;
} {
	const { account, chainId, library } = useActiveWeb3React();
