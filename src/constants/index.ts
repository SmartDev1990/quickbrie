...
import { injected, walletconnect, walletlink, portis, safeApp } from '../connectors';
...
export const GlobalConst = {
	...
	addresses: {
		ROUTER_ADDRESS: {
			...
			[ChainId.TESTNET]: '0x5635149e37007885017eb8c92EfD79F02747b1dF',
		},
...
export const GlobalValue = {
	percents: {
		ALLOWED_PRICE_IMPACT_LOW: new Percent(JSBI.BigInt(100), GlobalConst.utils.BIPS_BASE), // used for warning states // 1%
		ALLOWED_PRICE_IMPACT_MEDIUM: new Percent(JSBI.BigInt(300), GlobalConst.utils.BIPS_BASE), // 3%
		ALLOWED_PRICE_IMPACT_HIGH: new Percent(JSBI.BigInt(500), GlobalConst.utils.BIPS_BASE), // 5%
		PRICE_IMPACT_WITHOUT_FEE_CONFIRM_MIN: new Percent(JSBI.BigInt(1000), GlobalConst.utils.BIPS_BASE), // if the price slippage exceeds this number, force the user to type 'confirm' to execute // 10%
		BLOCKED_PRICE_IMPACT_NON_EXPERT: new Percent(JSBI.BigInt(1500), GlobalConst.utils.BIPS_BASE), // for non expert mode disable swaps above this // 15%
	},
	tokens: {
		MAINNET: WETH[ChainId.MAINNET],
		COMMON: {
			EMPTY: new Token(ChainId.MAINNET, '0x0000000000000000000000000000000000000000', 0, 'EMPTY', 'EMPTY'),
			USDC: new Token(ChainId.MAINNET, '0xcf2DF9377A4e3C10e9EA29fDB8879d74C27FCDE7', 6, 'USDC', 'USDC'),
			USDT: new Token(ChainId.MAINNET, '0xDe14b85cf78F2ADd2E867FEE40575437D5f10c06', 6, 'USDT', 'Tether USD'),
			OLD_QUICK: new Token(
				ChainId.MAINNET,
			...
			ETHER: new Token(ChainId.MAINNET, '0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619', 18, 'ETH', 'Ether'),
			CXETH: new Token(
				ChainId.MAINNET,
...
export const GlobalData = {
	bases: {
		...
		CUSTOM_BASES: { [ChainId.MAINNET]: undefined, [ChainId.TESTNET]: undefined },
